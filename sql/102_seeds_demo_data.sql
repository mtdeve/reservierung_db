...
-- 1. GERÄTETYPEN
-- ============================================================
INSERT INTO geraetetyp (geraetetyp_bezeichnung, preis_pro_tag) VALUES
('Laptop_test',  3.00),   -- hat mehrere Items → Mehrfach-Item-Tests
('Beamer_test',  4.00),   -- hat nur ein Item  → Engpass-Test
('Tablet_test',  2.00),   -- hat gar kein Item → Modell-ohne-Item-Test
('Drucker_test', 4.00);   -- reserviert        → Overlap-Test
